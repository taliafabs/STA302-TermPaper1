...
The data analysis component of this paper explores the details of shooting occurrence trends across all geographical divisions of the City of Toronto from 2014 to 2019. The data analysis examines trends in the number of shooting occurrences across the City of Toronto and within each geographical division from 2014 to 2019. Additionally, variation in the number of shooting occurrences between geographical divisions each year from 2014 to 2019 will be analyzed.
